...
import chefJase from './Images/chefjase.png';
      ...
      <div className="jumbotron" style={{position : 'relative', zIndex: "10"}}>
        <div className="row justify-content-center">
          <div className="col">
            ...
            <h3 className="lead">Celebrity Chef / Job Candidate: <span style={{fontStyle: "italic"}}>James "Jase" Leu</span></h3>
          </div>
          <div className="col ml-auto">
            <img src={chefJase} style={{ maxWidth: '20rem', maxHeight:'20rem'}} alt="Chef Jase"/>
          </div>
        </div>
        <hr className="my-4"/>
